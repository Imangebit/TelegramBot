...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    public static final String NAME = "java_rash_cat_bot"; // TODO: добавьте имя бота в кавычках
    public static final String TOKEN = "6857486882:AAGEwSnzg-AAV3LqZLD_zysAeeT5L5uh2fA"; //TODO: добавьте токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update updateEvent) {
        ...
        if (getCallbackQueryButtonKey().equals("step_1_btn")) {
            ...
            sendTextMessageAsync(STEP_2_TEXT,
                    Map.of( "Взять сосиску! +20 славы", "step_2_btn",
                            ...
                            "Сбросить банку с огурцами! +20 славы", "step_2_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_8_btn")) {
            sendImageMessageAsync("C:\\Projects Demo\\images\\final_pic.jpg");
            sendTextMessageAsync(FINAL_TEXT);
        }

        if (getMessageText().equals("/glory")){
            String glory = String.valueOf(getUserGlory());
            sendTextMessageAsync(glory);
        }
